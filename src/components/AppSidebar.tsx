    ...
    <Sidebar collapsible="icon">
      <SidebarHeader className="border-b border-sidebar-border">
        <div className="flex items-center gap-2 px-2 py-1.5">
          <div
            className="h-11 w-11 shrink-0 rounded-lg overflow-hidden flex items-center justify-center ring-1 ring-sidebar-border"
            style={{ boxShadow: "var(--shadow-glow)" }}
          >
            <img src={logoAsset.url} alt="Asia Tours and Travel" className="h-full w-full scale-125 object-contain" width={44} height={44} />
          </div>
