    ...
    return (
      <div className="flex items-center gap-1.5">
        ...
        <Button
          asChild
          size="sm"
          className="h-9 md:h-10 px-2 md:px-3 gap-1 md:gap-1.5 text-xs md:text-sm font-semibold bg-sky-500/15 hover:bg-sky-500/25 text-sky-400"
        >
          <Link to="/my-handover">
        ...
        <Button
          asChild
          size="sm"
          className={`h-9 md:h-10 px-2 md:px-3 gap-1 md:gap-1.5 text-xs md:text-sm font-semibold ${hasPending ? "bg-amber-500 hover:bg-amber-500/90 text-amber-950" : "bg-amber-500/15 hover:bg-amber-500/25 text-amber-400"}`}
        >
          <Link to="/md-panel">
