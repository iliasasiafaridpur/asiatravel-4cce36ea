...
export const MODULES: ModuleSchema[] = [
  {
    ...
    fields: [
      ...
      { name: "status", label: "Status", type: "text", showInList: true, section: "passenger", lookup: "status_delivery", lookupDefaults: STATUS_DELIVERY },
    ...
    listOrder: [
      "entry_date", "passenger_name", "passport", "mobile", "airline", "trip_road", "flight_date",
      "agency_sold", "vendor_bought", "status",
      "sold_price", "cost_price", "received", "due", "profit",
      "notes", "entry_by",
    ],
    computed: [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "sold_price", label: "PRICE", type: "number", showInList: true, section: "passenger" },
      { name: "status", label: "Status", type: "text", showInList: true, section: "passenger", lookup: "status_bmet", lookupDefaults: STATUS_BMET, defaultEmpty: true },
